package org.jeecg.modules.wxBanner.entity;
...
public class WxBanner implements Serializable {
	...
	/**banner名称*/
	@Excel(name = "banner名称", width = 15)
	private java.lang.String bannerName;
	/**图片url*/
	@Excel(name = "图片url", width = 15)
	private java.lang.String imgUrl;
	/**跳转路经*/
	@Excel(name = "跳转路经", width = 15)
	private java.lang.String jumpRoute;
	/**跳转类型*/
	@Excel(name = "跳转类型", width = 15)
