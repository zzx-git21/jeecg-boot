...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	@Override
	@Transactional
	public void addRoleUpdateStudy(WxStudy study,SysUser user, String roles) {
		this.save(user);
		if(oConvertUtils.isNotEmpty(roles)) {
			String[] arr = roles.split(",");
			for (String roleId : arr) {
		...
		wxStudyService.updateById(study);
	}
	@Override
	public Page<Map<String,Object>>  queryStudentUserList(Page<Map<String,Object>> page,String userName){
		return page.setRecords(userMapper.queryStudentUserList(page, userName));
	}
	
	@Override
	public Page<Map<String,Object>>  queryUserListByRole(Page<Map<String,Object>> page,String userName,String roleId){
		return page.setRecords(userMapper.queryUserListByRole(page, userName,roleId));
	}
